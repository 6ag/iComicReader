...
- (void)addGradient{
    ...
    gradientLayer.frame = CGRectMake(self.titleContentView.bounds.origin.x, self.titleContentView.bounds.origin.y, kScreenWidth, self.titleContentView.bounds.size.height);
    gradientLayer.zPosition = -1;
    UIColor *graidentColor = [UIColor blackColor];
    gradientLayer.locations = @[@0];
    gradientLayer.colors = @[(__bridge id)[graidentColor colorWithAlphaComponent:0.8].CGColor, (__bridge id)[graidentColor colorWithAlphaComponent:0.0].CGColor];
